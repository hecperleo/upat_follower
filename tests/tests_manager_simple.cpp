...
TEST_F(MyTestSuite, interp1) {
    ...
    nav_msgs::Path path_interp1 = mg.createPathInterp1(list_pose_x, list_pose_y, list_pose_z, list_pose_x.size(), new_path_size);
    EXPECT_EQ(path_interp1.poses.size(), new_path_size);
}
