...
class PathManager {
   ...
   private:
    ...
    std::vector<double> list_init_x = {-2.50,-2.66, -20, -25.75, -25.75, -14.25, -14.25, -2.50/* , -2.66 */};
    std::vector<double> list_init_y = {5.10, 5.0, 0.0, -4.0, 5.0, 5.0, -4.0, -4.0/* , 5.0 */};
    std::vector<double> list_init_z = {2.25, 14.0, 14.0, 10, 10.0, 10.0, 10.0, 2.25/* , 14.0 */};
    // Params
    int uav_id;
    bool save_csv;
};