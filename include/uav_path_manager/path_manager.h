...
class PathManager {
   ...
   private:
    ...
    // Services
    ros::ServiceClient srv_take_off_, srv_land_, srv_generated_path_, srv_give_generated_path_;
    // Variables
    ...
    std::vector<double> list_init_x_ = {-2.50,-2.66, -20, -25.75, -25.75, -14.25, -14.25, -2.50/* , -2.66 */};
    std::vector<double> list_init_y_ = {5.10, 5.0, 0.0, -4.0, 5.0, 5.0, -4.0, -4.0/* , 5.0 */};
    std::vector<double> list_init_z_ = {2.25, 14.0, 14.0, 10, 10.0, 10.0, 10.0, 2.25/* , 14.0 */};
    // Params
    int uav_id_;
    bool save_csv_;
};